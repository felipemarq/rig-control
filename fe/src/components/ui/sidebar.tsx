  ...
  return (
    <SidebarContext.Provider value={{ state, open, onOpenChange }}>
      <div
        ...
        className={cn(
          "flex min-h-screen bg-accent/40 pl-0 transition-all duration-300 ease-in-out data-[sidebar=closed]:pl-0 sm:pl-[--sidebar-width]",
          className
        )}
        {...props}
      />
  ...
  ({ className, children }, ref) => {
    ...
    const sidebar = (
      <div
        ref={ref}
        className={cn(
          "flex h-full flex-col border-r bg-primary text-white",
          className
        )}
      >
        {children}
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "flex flex-1 flex-col gap-5 overflow-auto py-4 text-white",
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      className={cn("grid gap-2 px-2.5 text-white", className)}
      {...props}
    />
  );
});
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      className={cn("px-1.5 text-xs font-medium text-white", className)}
      {...props}
    />
  );
});
