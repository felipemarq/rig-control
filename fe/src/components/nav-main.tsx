          ...
          <div className="grid gap-1 p-1.5 text-sm">
            {results.map((result) => (
              ...
              >
                ...
                <div className="line-clamp-2 text-white">{result.teaser}</div>
              </Link>
            ))}
            <Separator className="my-1.5" />
            <Link
              to="#"
              className="rounded-md px-2.5 py-1 text-white outline-none ring-ring hover:text-foreground focus-visible:ring-2"
            >
              See all results
            </Link>
          </div>
