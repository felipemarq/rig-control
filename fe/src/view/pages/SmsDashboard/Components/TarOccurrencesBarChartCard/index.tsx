...
export const TarOccurrencesBarChartCard = () => {
  ...
  const convertedResul = occurrencesTaxes?.tarOccurrences?.map((occurrence) => {
    if (!occurrence) {
      return {
        month: 0,
        tax: 0,
  ...
  return (
    <Card className="">
      <CardHeader>
        <CardTitle>Taxa de Acidentes Registrados (TAR) por Mês </CardTitle>
        <CardDescription>
          A TAR representa a taxa de acidentes registrados, calculado com base no número
